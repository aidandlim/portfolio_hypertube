    ...
    const _handleForm = e => {
        ...
        signin(form.userName, form.password, res => {
            if (res === 401) {
                ...
                confirmAlert({
                    message: 'Do you want to keep your signin status?',
                    buttons: [
                        {
                            label: 'Yes',
                            onClick: () =>
        ...
        <div className='auth'>
            <div className='auth-container'>
                ...
                <div className='auth-division'>
                    ...
                    <div className='auth-division-text'>
                        {ui.lang === 'en_US' ? 'OR' : '혹은'}
                    </div>
                </div>
                <div className='auth-title'>
                ...
                <div className='auth-social'>
                    <div className='auth-social-button google'>GOOGLE</div>
                    <div className='auth-social-button facebook'>FACEBOOK</div>
                    <div className='auth-social-button siliconvalley'>42SV</div>
                </div>
            </div>
        </div>
    );
